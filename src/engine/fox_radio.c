...
void Radio_PlayMessage(u16* msg, RadioCharacterId d) {
    ...
    if (CVarGetInteger("gPortraitRando", 0) == 1) {
        if (CVarGetInteger("gLevelPortraits", 0) == 1) {
            RadioCharacterId levelCharacter = -1;
            switch (gCurrentLevel) {
                case LEVEL_CORNERIA:
                    RadioCharacterId level1CharIndex[] = { RCID_BOSS_CORNERIA, RCID_BOSS_CORNERIA2 };
                    levelCharacter = level1CharIndex[RAND_INT(ARRAY_COUNT(level1CharIndex))];
                    break;
                case LEVEL_METEO:
                    RadioCharacterId level2CharIndex[] = { RCID_BOSS_METEO };
                    levelCharacter = level2CharIndex[RAND_INT(ARRAY_COUNT(level2CharIndex))];
                    break;
                case LEVEL_FORTUNA:
                case LEVEL_BOLSE:
                case LEVEL_VENOM_2:
                    RadioCharacterId level3CharIndex[] = { RCID_WOLF, RCID_LEON, RCID_ANDREW, RCID_PIGMA };
                    levelCharacter = level3CharIndex[RAND_INT(ARRAY_COUNT(level3CharIndex))];
                    break;
                case LEVEL_KATINA:
                    RadioCharacterId level4CharIndex[] = { RCID_WOLF, RCID_LEON, RCID_ANDREW, RCID_PIGMA, RCID_BILL };
                    levelCharacter = level4CharIndex[RAND_INT(ARRAY_COUNT(level4CharIndex))];
                    break;
                case LEVEL_SECTOR_X:
                    RadioCharacterId level5CharIndex[] = { RCID_BOSS_SECTORX };
                    levelCharacter = level5CharIndex[RAND_INT(ARRAY_COUNT(level5CharIndex))];
                    break;
                case LEVEL_MACBETH:
                    RadioCharacterId level6CharIndex[] = { RCID_BOSS_MACBETH };
                    levelCharacter = level6CharIndex[RAND_INT(ARRAY_COUNT(level6CharIndex))];
                    break;
                case LEVEL_SECTOR_Y:
                    RadioCharacterId level7CharIndex[] = { RCID_BOSS_SECTORY };
                    levelCharacter = level7CharIndex[RAND_INT(ARRAY_COUNT(level7CharIndex))];
                    break;
                case LEVEL_ZONESS:
                    RadioCharacterId level8CharIndex[] = { RCID_BOSS_ZONESS, RCID_KATT };
                    levelCharacter = level8CharIndex[RAND_INT(ARRAY_COUNT(level8CharIndex))];
                    break;
                case LEVEL_AREA_6:
                    RadioCharacterId level9CharIndex[] = { RCID_BOSS_AREA6, RCID_CAIMAN_AREA6 };
                    levelCharacter = level9CharIndex[RAND_INT(ARRAY_COUNT(level9CharIndex))];
                    break;
                case LEVEL_VENOM_ANDROSS:
                    RadioCharacterId level10CharIndex[] = { RCID_ANDROSS };
                    levelCharacter = level10CharIndex[RAND_INT(ARRAY_COUNT(level10CharIndex))];
                case LEVEL_TRAINING:
                    RadioCharacterId level11CharIndex[] = { RCID_TR };
                    levelCharacter = level11CharIndex[RAND_INT(ARRAY_COUNT(level11CharIndex))];
                    break;
                default:
                    break;
            }
            if (levelCharacter != -1) {
                RadioCharacterId charIndex[] = { levelCharacter, levelCharacter,  RCID_FALCO,   RCID_SLIPPY,
                                                 RCID_PEPPY,     RCID_FOX,        RCID_FALCO,   RCID_SLIPPY,
                                                 RCID_PEPPY,     RCID_FOX,        RCID_JAMES,   RCID_ROB64,
                                                 RCID_ROB64,     RCID_GEN_PEPPER, RCID_ANDROSS, RCID_KATT,
                                                 RCID_BILL };
                character = charIndex[RAND_INT(ARRAY_COUNT(charIndex))];
            } else {
                RadioCharacterId charIndex[] = { RCID_FALCO,  RCID_SLIPPY,     RCID_PEPPY,   RCID_FOX,   RCID_FALCO,
                                                 RCID_SLIPPY, RCID_PEPPY,      RCID_FOX,     RCID_JAMES, RCID_ROB64,
                                                 RCID_ROB64,  RCID_GEN_PEPPER, RCID_ANDROSS, RCID_KATT,  RCID_BILL };
                character = charIndex[RAND_INT(ARRAY_COUNT(charIndex))];
            }
        } else {
            RadioCharacterId charIndex[] = { RCID_FALCO,
                                             RCID_SLIPPY,
                                             RCID_PEPPY,
                                             RCID_FOX,
                                             RCID_FALCO,
    ...
    if (((character == RCID_FOX) || (character == RCID_FOX_RED)) &&
        ((gExpertMode && CVarGetInteger("gPortraitRando", 0) == 0) ||
...
void Radio_Draw(void) {
    ...
    if (((gRadioState > 0) && (gRadioState != 100)) && !gHideRadio) {
        ...
        if (((radioCharId == RCID_WOLF) || (radioCharId == RCID_PIGMA) || (radioCharId == RCID_LEON) ||
            ...
            (gCurrentLevel == LEVEL_FORTUNA || gCurrentLevel == LEVEL_BOLSE || gCurrentLevel == LEVEL_VENOM_2 ||
